package com.builders.cliente.config;
...
public class SwaggerConfig {
	...
	public Docket detalheApi() {
		...
		.select()
		.apis(RequestHandlerSelectors.basePackage("com.builders.cliente"))
	...
	private ApiInfoBuilder informacoesApi() {
		...
		apiInfoBuilder.title("API REST Cliente");
		apiInfoBuilder.description("Desafio Plataform Builders - API REST de cliente");
